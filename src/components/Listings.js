...
export default function Listings() {
    return (
        <div style={{ margin: 'auto' }}>
            <h2 style={{ marginTop: '15px' }}>Browse Stores in Wichita</h2>
            <Container style={{ marginTop: '50px' }}>
                <Row className="justify-content-md-center" style={{ borderBottom: "1px solid #E8E9EB", display: "flex", justifyContent: "space-evenly" }} >
                    <Row>
                        <Col xs=".5" >
